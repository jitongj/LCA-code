...
% load('randomsplit_training.mat') % bigdata small range (precised), 20 random seed
...
%% Load final full data to save time
%load('randomsplit_training_compelete_result.mat')
%%
% 将单元格数组 C2 转换为数值矩阵
